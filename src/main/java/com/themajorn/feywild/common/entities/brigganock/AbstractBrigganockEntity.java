...
public abstract class AbstractBrigganockEntity extends MonsterEntity {

    protected static final DataParameter<Boolean> DATA_IMMUNE_TO_ZOMBIFICATION = EntityDataManager.defineId(AbstractBrigganockEntity.class, DataSerializers.BOOLEAN);
    protected int timeInOverworld = 0;

    public AbstractBrigganockEntity(EntityType<? extends AbstractBrigganockEntity> p_i241915_1_, World p_i241915_2_) {
    ...
    @OnlyIn(Dist.CLIENT)
    public abstract BrigganockAction getArmPose();
    ...
    public void playAmbientSound() {
        if (BrigganockTasks.isIdle(this)) {
