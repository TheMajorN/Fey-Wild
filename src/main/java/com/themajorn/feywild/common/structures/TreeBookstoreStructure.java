...
public class TreeBookstoreStructure extends Structure<NoFeatureConfig> {

    public TreeBookstoreStructure() {
    ...
    protected boolean isFeatureChunk(ChunkGenerator chunkGenerator, BiomeProvider biomeProvider, long seed,
                                     SharedSeedRandom chunkRandom, int chunkX, int chunkZ,
                                     Biome biome, ChunkPos chunkPos, NoFeatureConfig noFeatureConfig) {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return TreeBookstoreStructure.Start::new;
    }
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.addPieces(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            .get(new ResourceLocation(FeyWild.MOD_ID, "tree_book_store/start_pool")),
